...
#Creating the stream-lit app
pipe = pickle.load(open('pipe.pkl','rb'))



#create app
st.title('Accident Prediction using Pipelines')
...
Type_of_vehicle = st.selectbox('Type of Vehicle',
                               ['Automobile', 'Public (> 45 seats)', 'Lorry (41?100Q)', 'Public (13?45 seats)',
...
Work_of_casuality = st.selectbox('Work of Casualty',
                                 ['Driver', 'Other', 'Unemployed', 'Employee', 'Self-employed', 'Student', 'Unknown'])
